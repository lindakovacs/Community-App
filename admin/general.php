...
class PL_Admin_General extends PL_Admin_Page {
	...
	public static function existing_api_key_view() {
		if(PL_Option_Helper::api_key()) : ?>
			<p class="message"><b>Note:</b><i> Changing your Placester API Key will completely switch all the listings on
				your website and delete all your current listing pages. <strong>This might not be what you want.</strong></i></p>
		<?php endif; ?>
