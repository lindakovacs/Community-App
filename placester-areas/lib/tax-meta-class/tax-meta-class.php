...
class Tax_Meta_Class {
	...
	public function __construct ( $meta_box ) {
		...
		$this->SelfPath = trailingslashit(PL_AREAS_URL) . 'lib/tax-meta-class';
	...
	public function load_scripts_styles() {
		...
		*/
		...
		if (in_array($taxnow,$this->_meta_box['pages'])) {
			...
			wp_enqueue_script( 'tax-meta-clss', $this->SelfPath . '/js/tax-meta-class.js', array( 'jquery' ), null, true );
