...
//				),
				...
				// Fields for the New Orleans MLS only
				'dwelling_type' => array(
					'attr_type' => 'text',
					'multi' => '1',
					'label' => 'Dwelling Type',
					...
					'bound' => array(
						'class' => 'PL_Listing_Helper',
						'method' => 'types_for_options',
						'params' => array(false, false, 'uncur_data.dwelling_type')
					)
				),
				'style' => array(
					'attr_type' => 'text',
				...
				'exterior' => array(
					...
					'bound' => array(
						'class' => 'PL_Listing_Helper',
						'method' => 'types_for_options',
						'params' => array(false, false, 'uncur_data.exterior')
					)
				),
				'stories' => array(
					'attr_type' => 'int',
				...
				'condition' => array(
					...
					'bound' => array(
						'class' => 'PL_Listing_Helper',
						'method' => 'types_for_options',
						'params' => array(false, false, 'uncur_data.condition')
					)
				),
				...
				'lot_description' => array(
					...
					'bound' => array(
						'class' => 'PL_Listing_Helper',
						'method' => 'types_for_options',
						'params' => array(false, false, 'uncur_data.lot_description')
					)
				),
				'pool_type' => array(
					'attr_type' => 'text',
				...
				'car_storage' => array(
					...
					'bound' => array(
						'class' => 'PL_Listing_Helper',
						'method' => 'types_for_options',
						'params' => array(false, false, 'uncur_data.car_storage')
					)
				),

				'foreclosure_reo' => array(
					'attr_type' => 'text',
					'multi' => '1',
					'label' => 'Forclosure REO',
					'type' => 'select',
					'group' => 'finance',
					'bound' => array(
						'class' => 'PL_Listing_Helper',
						'method' => 'types_for_options',
						'params' => array(false, false, 'uncur_data.foreclosure_reo')
					)
				),
				'condo_fees' => array(
					'attr_type' => 'int',
				...
				'home_owner_fee_terms' => array(
					...
					'bound' => array(
						'class' => 'PL_Listing_Helper',
						'method' => 'types_for_options',
						'params' => array(false, false, 'uncur_data.home_owner_fee_terms')
					)
				),
				'hoa_mand' => array(
					'label' => 'HOA Fee Required',
					'type' => 'checkbox',
					'group' => 'finance'
				),
				...
				'pets_allowed' => array(
					...
					'bound' => array(
						'class' => 'PL_Listing_Helper',
						'method' => 'types_for_options',
						'params' => array(false, false, 'uncur_data.pets_allowed')
					)
				),
				'pet_retrictions' => array(
					'label' => 'Pets Restricted',
					'type' => 'checkbox',
					'group' => 'pets'
				),
				...
				'heating' => array(
					...
					'bound' => array(
						'class' => 'PL_Listing_Helper',
						'method' => 'types_for_options',
						'params' => array(false, false, 'uncur_data.heating')
					)
				),
				'air_conditioning' => array(
					...
					'bound' => array(
						'class' => 'PL_Listing_Helper',
						'method' => 'types_for_options',
						'params' => array(false, false, 'uncur_data.air_conditioning')
					)
				),
				...
				'area' => array(
					...
					'bound' => array(
						'class' => 'PL_Listing_Helper',
						'method' => 'types_for_options',
						'params' => array(false, false, 'uncur_data.area')
					)
				),
				'neighborhood_name' => array(
					'attr_type' => 'text',
					'multi' => '1',
					'label' => 'MLS Neighborhood Name',
					'type' => 'select',
					'group' => 'location',
					'bound' => array(
						'class' => 'PL_Listing_Helper',
						'method' => 'types_for_options',
						'params' => array(false, false, 'uncur_data.neighborhood_name')
					)
				),
			),
...
//			),
			...
			'include_disabled' => array('type' => 'checkbox', 'group' => 'listing types','label' => 'Include Inactive'),
